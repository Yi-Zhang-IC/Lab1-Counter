...
void Vcounter::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+4,"load_en", false,-1);
        tracep->declBus(c+5,"load_val", false,-1, 7,0);
        tracep->declBus(c+6,"count", false,-1, 7,0);
        tracep->declBus(c+7,"counter WIDTH", false,-1, 31,0);
        tracep->declBit(c+1,"counter clk", false,-1);
        tracep->declBit(c+2,"counter rst", false,-1);
        tracep->declBit(c+3,"counter en", false,-1);
        tracep->declBit(c+4,"counter load_en", false,-1);
        tracep->declBus(c+5,"counter load_val", false,-1, 7,0);
        tracep->declBus(c+6,"counter count", false,-1, 7,0);
    }
}
...
void Vcounter::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+4,(vlTOPp->load_en));
        tracep->fullCData(oldp+5,(vlTOPp->load_val),8);
        tracep->fullCData(oldp+6,(vlTOPp->count),8);
